...
const HELP_MENU = {
  help_main: {
    ...
    rows: [
      ...
      [['Economy', 'help_eco'], ['Games', 'help_games'], ['Anime', 'help_anime']],
      [['AI Chatbot', 'help_ai']],
  ...
  help_eco: { title: '<b>💰 Economy</b>\n\n/balance or /bal — check your (or anyone\'s) wallet\n/daily — claim daily coins\n/weekly — claim weekly bonus\n/leaderboard — top richest users\n/give &lt;amt&gt; (reply) — send coins\n\n<b>🗡 Kill Game</b>\n/kill (reply) — kill a user, earn <b>+100 coins</b>\n/protect 1day — shield yourself for <b>300 coins</b>\n/protect 2day — shield for <b>500 coins</b>\n/rob &lt;amt&gt; (reply) — steal coins (fail = lose 100)', back: 'help_main' },
  help_games: { title: '<b>🎮 Games</b>\n\n/wordguess + /gamew &lt;5-letter&gt;\n/trivia\n/8ball &lt;question&gt;\n/truth — random truth\n/dare — random dare\n/tod — random truth or dare\n/ship (reply) — ship meter 💕', back: 'help_main' },
  help_anime: { title: '<b>🌸 Anime Actions</b>\n\n/hug /pat /kiss /slap /poke\n/bite /cuddle /tickle /wave\n/steal — steal a sticker (reply)\n\nAll send anime GIFs from nekos.best ✨', back: 'help_main' },
